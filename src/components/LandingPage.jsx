  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <h1 className="mt-60px w-96 text-center font-bold text-primary md:text-primarymd text-col240d57 leading-9 md:leading-12">
        Imagine if
        <br />
        <span className="bg-clip-text text-transparent bg-gradient-to-r from-col8456ec to-cole87bf8">Snapchat</span>
        <br />
        had events.
      </h1>
      ...
      <Link to="/create" className="bg-gradient-to-r from-col8456ec to-cole87bf8 px-21px py-16px rounded-xl mb-13.6px font-bold text-white">
        🎉 Create my event
      </Link>
    </div>
  );
